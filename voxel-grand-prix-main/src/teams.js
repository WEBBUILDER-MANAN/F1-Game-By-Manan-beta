...
const RB = {
  id: 'redbull',
  name: 'Red Bull RB18', short: 'RB18', number: 1,
  fullName: 'Oracle Red Bull Racing RB18',
  year: 2022, driverNote: '2022 World Champion car',
  desc: 'Downwash sidepods and a raised rear stance; the dominant 17-win package of the season.',
...
const FER = {
  id: 'ferrari',
  name: 'Ferrari F1-75', short: 'F1-75', number: 16,
  fullName: 'Scuderia Ferrari F1-75',
  year: 2022, driverNote: '75th anniversary special',
  desc: 'A bathtub sidepod concept with a season-four race-winning scarlet shape.',
...
const MER = {
  id: 'mercedes',
  name: 'Mercedes W13', short: 'W13', number: 44,
  fullName: 'Mercedes-AMG F1 W13 E Performance',
  year: 2022, driverNote: 'Radical zero-sidepod concept',
  desc: 'The most extreme zero-sidepod design, a bold Silver Arrow aerodynamic experiment.',
...
const MCL = {
  id: 'mclaren',
  name: 'McLaren MCL36', short: 'MCL36', number: 4,
  fullName: 'McLaren F1 Team MCL36',
  year: 2022, driverNote: 'Papaya orange challenger',
  desc: 'Deep undercut sidepods and a front pull-rod setup; an orange racing weapon.',
...
const ALP = {
  ...
  year: 2022, driverNote: 'French blue × BWT pink',
  desc: 'Renault’s blue arrow, with deep undercut sidepods and pink accents.',
...
const AMR = {
  id: 'astonmartin',
  name: 'Aston Martin AMR22', short: 'AMR22', number: 5,
  fullName: 'Aston Martin Aramco AMR22',
  year: 2022, driverNote: 'British racing green · lime trim',
  desc: 'A mid-season updated green-downwash concept in elegant British racing green.',
...
const WIL = {
  id: 'williams',
  name: 'Williams FW44', short: 'FW44', number: 23,
  fullName: 'Williams Racing FW44',
  year: 2022, driverNote: 'Legacy of an independent team',
  desc: 'A slab-sided aerodynamic experiment with deep navy and electric blue styling.',
...
const ALF = {
  id: 'alfaromeo',
  name: 'Alfa Romeo C42', short: 'C42', number: 77,
  fullName: 'Alfa Romeo F1 Team ORLEN C42',
  year: 2022, driverNote: 'Burgundy and white heritage',
  desc: 'A lightweight championship-era concept with a white nose and burgundy rear body.',
...
const ATR = {
  ...
  year: 2022, driverNote: 'Deep navy fashion label',
  desc: 'A deep navy racing suit with clean white lines, signed by the Red Bull junior squad.',
...
const HAA = {
  id: 'haas',
  name: 'Haas VF-22', short: 'VF-22', number: 20,
  fullName: 'Haas F1 Team VF-22',
  year: 2022, driverNote: 'Stars-and-stripes · American power',
  desc: 'A white carbody with red-blue accents and a practical American race-team finish.',
